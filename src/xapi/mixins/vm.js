...
import { cancelable, catchPlus as pCatch, ignoreErrors } from 'promise-toolbox'
import {
  find,
  gte,
  includes,
...
export default {
  ...
  @cancelable
  @deferrable
  async createVm ($defer, $cancelToken, templateId, {
    ...
    if (!isEmpty(vdis)) {
      ...
      await asyncMap(vdis, (vdiDescription, i) => this.createVdi({
